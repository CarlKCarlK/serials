...
async fn test_led12x4_pio0_write_text(
    ...
    let led_12x4 = Led12x4Pio0::new(&LED_12X4_STATIC, p.PIO0, p.PIN_3, Milliamps(500), spawner).await?;

    led_12x4
        .write_text("1234", &[colors::RED, colors::GREEN, colors::BLUE, colors::YELLOW])
        .await?;
...
async fn test_led12x4_pio1(p: embassy_rp::Peripherals, spawner: Spawner) -> serials::Result<()> {
    ...
    let _led_12x4 = Led12x4Pio1::new(&LED_12X4_STATIC, p.PIO1, p.PIN_3, Milliamps(500), spawner).await?;
