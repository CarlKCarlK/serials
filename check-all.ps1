...
# Run unit tests on host (x86_64-pc-windows-msvc) with host feature to test hardware-independent logic
cargo test --lib --target x86_64-pc-windows-msvc --no-default-features --features host
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
