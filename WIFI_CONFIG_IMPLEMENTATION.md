...
1. **AP Mode**: Device starts as an access point named "PicoClock" at IP 192.168.4.1
...
**Current Behavior**:
1. Starts in AP mode
2. Displays instructions to connect to "PicoClock"
...
2. Device starts AP "PicoClock"
3. Connect phone/computer to "PicoClock"
