...
///
/// This type is used through macro-generated wrapper types that deref to `LedStripShared`.
///
/// The [`define_led_strips_shared!`] macro generates wrapper types with associated constants
...
macro_rules! define_led_strips_shared {
    (
        ...
        paste::paste! {
            ...
            $(
                #[doc = concat!(
                    "LED strip wrapper generated by [`define_led_strips_shared!`].\n\n",
                    "Derefs to [`LedStripShared`] for all operations. ",
