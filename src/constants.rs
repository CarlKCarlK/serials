...
pub const CELL_COUNT_LED4_U8: u8 = 4;
pub const CELL_COUNT_LED4: usize = CELL_COUNT_LED4_U8 as usize;

/// The number of segments per digit in the display.
/// Each digit has 8 segments (7 segments plus a decimal point).
pub const SEGMENT_COUNT_LED4: usize = 8;
...
/// The map itself can hold up to `CELL_COUNT_LED4` entries, the most possible.
pub type BitsToIndexesLed4 = LinearMap<NonZeroU8, Vec<u8, CELL_COUNT_LED4>, CELL_COUNT_LED4>;
