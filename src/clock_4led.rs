...
pub type Clock4LedNotifier = (Clock4LedOuterNotifier, BlinkerNotifier);
...
async fn clock_4led_device_loop(clock_notifier: &'static Clock4LedOuterNotifier, blinker: Blinker<'static>) -> ! {
